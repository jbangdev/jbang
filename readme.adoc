...
[WARNING]
====
jbang is in the process of mvoing from https://github.com/maxandersen/jbang to https://github.com/jbangdev

Thus some install options might not be fully published yet!
====

...
user included dependencies to influence the generated jar and possible native image. An example could be to have Quarkus participate
to perform its buildtime optimizations rather than doing it at runtime every time.
...
Still very experimental and bound to change.

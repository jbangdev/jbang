...
jbang will check if a new version is available and print a message with instructions on how to update.

The check in the background and will only be done
every 24hrs on the same installation.

If you do not wish to have jbang check for a new version you can set `JBANG_NO_VERSION_CHECK` environment variable

...
link:skills/jbang/SKILL.md[`skills/jbang/SKILL.md`] is an https://agentskills.io[Agent Skill] that teaches AI coding agents how to install and drive JBang — including the native binary install via `JBANG_USE_NATIVE`. Add it to a project with:

[source, bash]
----
npx skills add jbangdev/jbang
----

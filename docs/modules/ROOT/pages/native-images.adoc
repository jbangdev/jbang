...
[NOTE]
====
Without these packages installed on Linux, native image compilation may fail with errors related to missing headers or libraries.
====
...
export GRAALVM_HOME=/Library/Java/JavaVirtualMachines/graalvm-jdk-25.jdk/Contents/Home

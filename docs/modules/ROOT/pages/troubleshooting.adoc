...
5. **UTF-8 console support**: JBang can enable UTF-8 console support by executing command  `chcp.com 65001`. To enable this functionality, set  environment variable `JBANG_WIN_ENABLE_UTF8` to `true`. UTF-8 support will remain enabled in the current console session after JBang terminates.

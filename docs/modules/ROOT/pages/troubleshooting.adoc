...
5. **UTF8 encoding**: JBang enables UTF-8 support at startup by executing command  `chcp 65001`. To disable this functionality, set  environment variable `JBANG_WIN_NO_UTF8` to `true`.

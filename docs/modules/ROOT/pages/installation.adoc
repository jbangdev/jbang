...
The Homebrew package includes the native executable for the host architecture on macOS and Linux. Set `JBANG_USE_NATIVE=true` to use it instead of the JAR-based launcher.

...
*template add* [*-h*=_<help>_] [*-d*=_<description>_] [*--name*=_<name>_] [*--force*] [*-P*=_<property>_] [*-g*] [*-f*=_<file>_] [*--config*=_<config>_] [*--insecure*] [*--verbose*] [*--quiet*] [*-o*] [*--fresh*] [*--preview*] [*-x*] [_<files>_...]

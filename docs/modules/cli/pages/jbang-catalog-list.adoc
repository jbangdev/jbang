...
catalog-list - Show currently defined catalogs.
...
*catalog list* [*-h*=_<help>_] [*--show-origin*] [*--format*=_<format>_] [*-g*] [*-f*=_<file>_] [*--config*=_<config>_] [*--insecure*] [*--verbose*] [*--quiet*] [*-o*] [*--fresh*] [*--preview*] [*-x*] [_<name>_]

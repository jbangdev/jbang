...
trust-list - Show defined trust domains.
...
*trust list* [*-h*=_<help>_] [*--format*=_<format>_] [*--config*=_<config>_] [*--insecure*] [*--verbose*] [*--quiet*] [*-o*] [*--fresh*] [*--preview*] [*-x*]

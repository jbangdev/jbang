...
*app install* [*--build-dir*=_build-dir_] [*--catalog*=_catalog_] [*--cds*] [*-C*=_compile-option_] [*--config*=_config_] [*--cp*=_cp_] [*-d*=_debug_] [*--deps*=_deps_] [*--enable-preview*] [*--enableassertions*] [*--enablesystemassertions*] [*--files*=_files_] [*--force*] [*--fresh*] [*-h*=_help_] [*--ignore-transitive-repositories*] [*--insecure*] [*--integrations*] [*-i*] [*-j*=_java_] [*--javaagent*=_javaagent_] [*--jfr*=_jfr_] [*--jsh*] [*-m*=_main_] [*--manifest*=_manifest_] [*--module*=_module_] [*--name*=_name_] [*-n*] [*-N*=_native-option_] [*--no-build*] [*-o*] [*--preview*] [*-D*=_properties_] [*--quiet*] [*--repos*=_repos_] [*-R*=_runtime-option_] [*-T*=_source-type_] [*-s*=_sources_] [*-x*] [*--verbose*] [__] [__...]

...
*app install* [*-h*=_<help>_] [*-R*=_<runtime-option>_] [*--jfr*=_<jfr>_] [*-d*=_<debug>_] [*--enableassertions*] [*--enablesystemassertions*] [*--javaagent*=_<javaagent>_] [*--cds*] [*-i*] [*--force*] [*--no-build*] [*--name*=_<name>_] [*-s*=_<sources>_] [*--files*=_<files>_] [*-T*=_<source-type>_] [*--jsh*] [*--catalog*=_<catalog>_] [*-j*=_<java>_] [*-m*=_<main>_] [*--module*=_<module>_] [*-C*=_<compile-option>_] [*--manifest*=_<manifest>_] [*--integrations*] [*-D*=_<properties>_] [*--deps*=_<deps>_] [*--repos*=_<repos>_] [*--cp*=_<cp>_] [*--ignore-transitive-repositories*] [*-n*] [*-N*=_<native-option>_] [*--build-dir*=_<build-dir>_] [*--enable-preview*] [*--config*=_<config>_] [*--insecure*] [*--verbose*] [*--quiet*] [*-o*] [*--fresh*] [*--preview*] [*-x*] [_<scriptOrFile>_] [_<params>_...]

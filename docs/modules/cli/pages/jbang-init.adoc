...
*jbang init* [*-h*] [*-j*=_<java>_] [*--ai-provider*=_<ai-provider>_] [*--ai-api-key*=_<ai-api-key>_] [*--ai-endpoint*=_<ai-endpoint>_] [*--ai-model*=_<ai-model>_] [*-t*=_<template>_] [*--force*] [*--edit*] [*-D*=_<properties>_] [*--deps*=_<deps>_] [*--config*=_<config>_] [*--insecure*] [*--verbose*] [*--quiet*] [*-o*] [*--fresh*] [*--preview*] [*-x*] [_<scriptOrFile>_] [_<params>_...]

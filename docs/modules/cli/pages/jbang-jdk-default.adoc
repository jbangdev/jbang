...
jdk-default - Sets the default JDK to be used by JBang.
...
*jdk default* [*-h*=_<help>_] [*-v*] [*-d*] [*--format*=_<format>_] [*--config*=_<config>_] [*--insecure*] [*--verbose*] [*--quiet*] [*-o*] [*--fresh*] [*--preview*] [*-x*] [_<versionOrId>_]

...
*jbang edit* *-o* [*-h*] *--fresh* [*--insecure*] [*--jsh*] [*--live*] [*--no-open*] *--quiet*
           *--verbose* [*--open*[=_<editor>_]] [*--config*=_<config>_]
           [*--cp*=_<classpaths>_]... [*-D*=_<String=String>_]...
           [*--deps*=_<dependencies>_]... [*--repos*=_<repositories>_]... _<scriptOrFile>_

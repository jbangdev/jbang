...
*jbang edit* [*--catalog*=_catalog_] [*--config*=_config_] [*--cp*=_cp_] [*--deps*=_deps_] [*--files*=_files_] [*--fresh*] [*-h*=_help_] [*--ignore-transitive-repositories*] [*--insecure*] [*--jsh*] [*--live*] [*--no-open*] [*-o*] [*--open*=_open_] [*--preview*] [*-D*=_properties_] [*--quiet*] [*--repos*=_repos_] [*-b*] [*-T*=_source-type_] [*-s*=_sources_] [*-x*] [*--verbose*] [__] [__...]

...
*template list* [*-h*=_<help>_] [*--show-origin*] [*--show-files*] [*--show-properties*] [*--format*=_<format>_] [*-g*] [*-f*=_<file>_] [*--config*=_<config>_] [*--insecure*] [*--verbose*] [*--quiet*] [*-o*] [*--fresh*] [*--preview*] [*-x*] [_<>_]

...
config-list - List active configuration values
...
*config list* [*-h*=_<help>_] [*--show-origin*] [*--show-available*] [*--format*=_<format>_] [*-g*] [*-f*=_<file>_] [*--config*=_<config>_] [*--insecure*] [*--verbose*] [*--quiet*] [*-o*] [*--fresh*] [*--preview*] [*-x*]

...
jdk-exec - Executes the given command using the default (or specified) JDK.
...
*jdk exec* [*-h*=_<help>_] [*-j*=_<java>_] [*--config*=_<config>_] [*--insecure*] [*--verbose*] [*--quiet*] [*-o*] [*--fresh*] [*--preview*] [*-x*] [_<command>_...]

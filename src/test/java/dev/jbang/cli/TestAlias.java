...
public class TestAlias extends BaseTest {
	...
	void testGetAliasFour() throws IOException {
		...
		assertThat(alias.arguments, iterableWithSize(2));
		assertThat(alias.arguments, contains("3", "4"));
		assertThat(alias.runtimeOptions, iterableWithSize(2));
		assertThat(alias.runtimeOptions, contains("--three", "--four"));
		assertThat(alias.sources, iterableWithSize(1));
		...
		assertThat(alias.properties, aMapWithSize(2));
		...
		assertThat(alias.compileOptions, iterableWithSize(2));
		assertThat(alias.compileOptions, contains("--cthree", "--cfour"));
		assertThat(alias.nativeImage, is(Boolean.FALSE));
		assertThat(alias.nativeOptions, iterableWithSize(2));
		assertThat(alias.nativeOptions, contains("--nthree", "--nfour"));

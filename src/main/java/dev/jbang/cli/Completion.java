...
@CommandDefinition(name = "completion", description = "Generate bash/zsh or fish completion script for jbang.", generateHelp = true, defaultValueProvider = JBangDefaultValueProvider.class)
public class Completion extends BaseCommand {
	...
	@Option(shortName = 's', name = "shell", description = "The shell to generate the completion script for. Supported shells: bash, zsh, and fish", defaultValue = "bash")

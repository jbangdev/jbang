...
public class JBangDefaultValueProvider implements DefaultValueProvider {
	...
	// Options that use fallbackValue/DebugOptionParser with "" (empty string) as a
	// sentinel for "used without value". The provider must not supply defaults for
	// these because the sentinel triggers config-file lookup in

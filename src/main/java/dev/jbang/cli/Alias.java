...
public class Alias extends BaseCommand {
	...
	public static class AliasAdd extends BaseCommand {
		...
		@Arguments(description = "Parameters for the script")
	...
	public static class AliasList extends BaseCommand {
		...
		static void printAliases(PrintStream out, String catalogName, Catalog catalog, String format) {
	...
	public static class AliasRemove extends BaseCommand {
		...
		@Argument(description = "The name of the alias", required = true)
		String name;

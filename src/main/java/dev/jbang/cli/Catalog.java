...
public class Catalog extends BaseCommand {
	...
	public static class CatalogAdd extends BaseCatalogCommand {
		...
		@Argument(description = "A file or URL to a catalog file", required = true)
		String urlOrFile;
	...
	public static class CatalogList extends BaseCatalogCommand {
		...
		@Argument(description = "The name of a catalog")
		String name;
			...
			if (name == null) {
				...
				if ("json".equals(format)) {
					...
					if (!catalog.aliases.isEmpty()) {
						out.println("Aliases:");
						out.println("--------");
						Alias.AliasList.printAliases(out, name, catalog, "text");
					}
					if (!catalog.templates.isEmpty()) {
						out.println("Templates:");
						out.println("----------");
						Template.TemplateList.printTemplates(out, name, catalog, false, false, "text");
					}
					if (!catalog.catalogs.isEmpty()) {
						out.println("Catalogs:");
						out.println("---------");
						printCatalogs(out, name, catalog, "text");
					}
				}
			}
			return EXIT_OK;
	...
	public static class CatalogRemove extends BaseCatalogCommand {
		...
		@Argument(description = "The name of the catalog", required = true)
		String name;
